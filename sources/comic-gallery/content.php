...
$pt->page_url_ = $pt->config->site_url . '/comic-gallery';
$pt->page        = 'comic-gallery';
$pt->title       = 'Create Comic Gallery | ' . $pt->config->title;
$pt->description = $pt->config->description;
$pt->keyword     = $pt->config->keyword;
$pt->content     = PT_LoadPage("comic-gallery/$content", array('CURRENCY'   => $currency));
